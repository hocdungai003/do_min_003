import { playClick, playReveal, playExplosion, playWin } from './sounds.js';
...
// Handle cell click (desktop left-click)
function handleCellClick(e) {
  ...
  // On desktop, left-click flags in flag mode, otherwise reveals
  if (window.innerWidth > 600 && isFlagMode) {
    handleFlag(row, col);
  } else {
...
// Handle right click (desktop flag toggle)
